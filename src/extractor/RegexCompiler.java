...
/**
 * Basic frame code given by Abbas Attarwala Returns information stored at a
 * given location within the url using the html code
 * 
...
public class RegexCompiler {
  /**
   * extractCodeInfo is a method that takes in parameters and returns the
   * information stored at the regex html code given within the code found at
   * the provided google scholar url
   * 
   * @param htmlRegex regex in html code
   * @param googleScholarURL
   * @return The information present at the given html regex
   */
  public static String extractCodeInfo(String htmlRegex,
